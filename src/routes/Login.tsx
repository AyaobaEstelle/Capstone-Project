  ...
  return (
    <div className="w-full min-h-screen login">
      <form action="#" method="POST" className="login-form">
        <h2 className="text-neutral-500">Log in with:</h2>
        ...
        <div className="or text-neutral-500">
        <hr />
        or
        <hr />
        </div>
        ...
        <p className="forget-password text-neutral-primary-200">forget password?</p>
        <button className="bg-neutral-primary-900 text-neutral-100">Log in</button>
        <h3 className="text-neutral-500">
          Don't have an account? <span className="text-neutral-primary-900">Sing up</span>
        </h3>
        <footer className="form-footer text-neutral-400">
          <p>
            By signing in with an account, you agree to the <br />Scissors{" "}
